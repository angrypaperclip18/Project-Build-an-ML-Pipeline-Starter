...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help = "name of initial uncleaned data",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "name of cleaned data output",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "this dataset has been cleaned",
        required = True
    )
